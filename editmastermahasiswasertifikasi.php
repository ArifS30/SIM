...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='mahasiswa/sertifikasi' and user = '". $_SESSION['Email'] ."' and editData='1'";
...
echo "<form action=editmastermahasiswasertifikasiexec.php method=post>";
