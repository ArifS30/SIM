...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='program_studi' and user = '". $_SESSION['Email'] ."' and editData='1'";
...
echo "<form action=editprogram_studiexec.php method=post>";
$result = mysqli_query($con, "SELECT * FROM program_studi where Kode = '". mysqli_real_escape_string($con, $_GET['Kode']) . "'");
while($row = mysqli_fetch_array($result))
{
echo "<tr><td colspan=2><input type=hidden name=pk value='" . $row['Kode'] . "'></td></tr>";
...
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Kode&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Kode' value='". $row['Kode'] ."' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Program_Studi&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Program_Studi' value='". $row['Program_Studi'] ."' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Kaprodi&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Kaprodi' value='". $row['Kaprodi'] ."' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;NIDN_Kaprodi&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='NIDN_Kaprodi' value='". $row['NIDN_Kaprodi'] ."' size = 100></td>";
