...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='mahasiswa/sertifikasi' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=insertmastermahasiswasertifikasiexec.php method=post enctype='multipart/form-data'>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>NIM</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='NIM' size = 100></td>";
