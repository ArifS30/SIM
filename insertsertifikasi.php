...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='sertifikasi' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=insertsertifikasiexec.php method=post enctype='multipart/form-data'>";
...
echo "<td bgcolor=CCEEEE><input type=text id='Tanggal_Daftar' name='Tanggal_Daftar'><font face=Verdana color=black size=1><script type='text/javascript'>calendar.set('Tanggal_Daftar');</script></font></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Tanggal_Ujian</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Tanggal_Ujian'></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Hasil_Ujian</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Hasil_Ujian' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Keterangan</font></td>";
echo "<td bgcolor=CCEEEE><textarea <textarea class='form-control' name='Keterangan' cols=70 rows=5 ></textarea></td>";
