...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='program_studi' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=insertprogram_studiexec.php method=post enctype='multipart/form-data'>";
