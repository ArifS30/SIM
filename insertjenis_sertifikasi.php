...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='jenis_sertifikasi' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=insertjenis_sertifikasiexec.php method=post enctype='multipart/form-data'>";
...
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Sertifikasi' size = 100></td>";
