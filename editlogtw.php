...
echo "<form action=editlogtwexec.php method=post>";
...
echo "<td bgcolor=CCEEEE><input type=text id='Time' name='Time' value='". $row['Time'] ."' size=10><script type='text/javascript'>calendar.set('Time');</script></td>";
...
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='IpAddress' value='". $row['IpAddress'] ."' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Information&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><textarea <textarea class='form-control' name='Information'>". $row['Information'] ."</textarea></td>";
