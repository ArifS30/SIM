...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='tw_tabel' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=inserttw_tabelexec.php method=post enctype='multipart/form-data'>";
