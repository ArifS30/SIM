...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='program_studi/mahasiswa' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=insertmasterprogram_studimahasiswaexec.php method=post enctype='multipart/form-data'>";
...
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Program_Studi' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Kaprodi</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Kaprodi' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>NIDN_Kaprodi</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='NIDN_Kaprodi' size = 100></td>";
