...
<div id="wrapper">     
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">   
            <div class="navbar-header">
                ...
                <img src="images/dbfde0605b856e4e6621b834511f7ca1.png" width="25" height="25">
                </div>
                <a class="navbar-brand" href="content.php">Universitas Sangga Buana</a>    
            </div>                             
            <!-- /.navbar-header -->      
            <ul class="nav navbar-top-links navbar-right">   
               <li class="dropdown">         
                    ...
                    <ul class="dropdown-menu dropdown-user">   
                        <li><a href="#"><font size=2><i class="fa fa-user fa-fw"></i>  <?php echo $_SESSION['Email'];?></font></a> 
                        </li>                
                        <li><a href="listsetting.php"><font size=2><i class="fa fa-gear fa-fw"></i> Settings</font></a>
                        </li>         
                    </ul>          
                    <!-- /.dropdown-user -->     
                </li>
