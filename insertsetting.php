...
echo "<form action=insertsettingexec.php method=post enctype='multipart/form-data'>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>ID</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='ID'></td>";
...
echo "<td bgcolor=CCEEEE><textarea <textarea class='form-control' name='Alamat' cols=70 rows=5 ></textarea></td>";
...
echo "<td bgcolor=CCEEEE><input type='file' class='form-control-file' id='upload_file' name='Logo'></td>"; 
echo "</div>";
