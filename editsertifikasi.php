...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='sertifikasi' and user = '". $_SESSION['Email'] ."' and editData='1'";
...
echo "<form action=editsertifikasiexec.php method=post>";
...
echo "<td bgcolor=CCEEEE><input type=text id='Tanggal_Daftar' name='Tanggal_Daftar' value='". $row['Tanggal_Daftar'] ."' size=10><script type='text/javascript'>calendar.set('Tanggal_Daftar');</script></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Tanggal_Ujian&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Tanggal_Ujian' value='". $row['Tanggal_Ujian'] ."'></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Hasil_Ujian&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Hasil_Ujian' value='". $row['Hasil_Ujian'] ."' size = 100></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Keterangan&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><textarea <textarea class='form-control' name='Keterangan'>". $row['Keterangan'] ."</textarea></td>";
