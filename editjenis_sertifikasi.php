...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='jenis_sertifikasi' and user = '". $_SESSION['Email'] ."' and editData='1'";
...
echo "<form action=editjenis_sertifikasiexec.php method=post>";
...
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Sertifikasi' value='". $row['Sertifikasi'] ."' size = 100></td>";
